...
namespace IntProg.Controllers
{
    ...
    public class YazarsController : Controller
    {
        ...
        public YazarsController(tiyatroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Yazars != null ?
                        ...
                        Problem("Entity set 'tiyatroContext.Yazars'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("YazarId,YazarAd,YazarMemleket,YazarYas")] Yazar yazar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("YazarId,YazarAd,YazarMemleket,YazarYas")] Yazar yazar)
        {
            if (id != yazar.YazarId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'tiyatroContext.Yazars'  is null.");
            }
            var yazar = await _context.Yazars.FindAsync(id);
            if (yazar != null)
            {
